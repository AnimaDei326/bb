<? $requisites =  $this->params['requisites'];?>
    ...
    <div class="topbar-left">
        <ol class="breadcrumb">
            <li class="crumb-active">
                <a href="/admin/header_footer/requisite">Реквизиты</a>
            </li>
            <li class="crumb-icon">
                <a href="/admin">
            ...
            <li class="crumb-trail">Реквизиты</li>
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" action="/headerfooter/edit" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="hidden" value="requisite" name="type">
                    </form>
                </div>
            </div>
        </div>
