...
<script>
    ...
    function addItem(){
        ...
        let div = "<div data-id=\""+newId+"\">"+
            ...
            "<input type=\"checkbox\" name=\""+itemActive+"\" id=\""+itemName+"\" checked>"+
            "<label for=\""+itemName+"\" data-on=\"Да\" data-off=\"Нет\"></label>"+
            "</label>"+
            "</div>"+
            "</div>"+
            "</div>"+
    ...
    <div class="topbar-left">
        <ol class="breadcrumb">
            <li class="crumb-active">
                <a href="/admin/about/photo">Галерея</a>
            </li>
            <li class="crumb-icon">
                <a href="/admin">
            ...
            <li class="crumb-trail">Галерея</li>
    ...
    <div class="tray tray-center">
        ...
        <div class="col-md-12">
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <form id="items" class="form-horizontal" role="form" action="/about/edit" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="panel mt50" id="spy2">
                                        ...
                                        <div class="panel-body">
                                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                                <div class="fileupload-preview thumbnail mb20">
                                                    <?if ($item['name']):?>
                                                        <img id="picture_<?=$item['id']?>" src="/images/<?=$item['name']?>" alt="<?=$item['name']?>">
                                                </div>
                                                <div class="row">
                                                    <div class="col-xs-6">
                                                        <span class="btn btn-system btn-file btn-block">
                        ...
                        <button id="btn-add-photo" class="btn btn-primary" onclick="addItem()" type="button">Добавить фотографию</button>
