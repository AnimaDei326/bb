...
<script>
    ...
    function addItemDone(){
        ...
        let newId = max + 1;
        let itemName = newId + '_new_item_done_name';
        let itemSort = newId + '_new_item_done_sort';
    ...
    function addItemResult(){
        ...
        let newId = max + 1;
        let itemName = newId + '_new_item_result_name';
        let itemSort = newId + '_new_item_result_sort';
                                ...
                                <table id="datatable2" class="table table-striped table-hover" cellspacing="0" width="100%">
                                    ...
                                    <?if($done):?>
                                        <? foreach ($done as $item):?>
                                            <tr data-id="<?=$item['id']?>">
                                                <td class="col-md-5 col-sm-4 col-xs-3"><input class="form-control" name="<?=$item['id']?>_item_name" value="<?=$item['name']?>"></td>
                                    ...
                                    <?endif;?>
                                    <tr data-id="-2">
                                        <td class="col-md-5 col-sm-4 col-xs-3"><input class="form-control" name="-2_item_name"></td>
                                        <td class="col-md-5 col-sm-4 col-xs-3"><input class="form-control" name="-2_item_sort" value="100" type="number"></td>
                                        <td class="text-right">
                                            <div class="bs-component">
                                                <div class="btn-group">
                                                    <span class="glyphicons glyphicons-pencil"></span>
                                                    <button onclick="deleteNewItemDone('-2')" type="button" class="btn btn-danger dark">
                                                        <i class="fa fa-delete">✗</i>
                                                        <!-- Удалить -->
                                                    </button>
                                                </div>
                                        ...
                                        <tr data-id="-1">
                                            ...
                                            <td class="text-right">
                                                <div class="bs-component">
                                                    <div class="btn-group">
                                                        <span class="glyphicons glyphicons-pencil"></span>
                                                        <button onclick="deleteNewItemResult('-1')" type="button" class="btn btn-danger dark">
                                                            <i class="fa fa-delete">✗</i>
                                                            <!-- Удалить -->
                                                        </button>
                                                    </div>
